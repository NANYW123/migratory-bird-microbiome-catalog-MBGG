#Here, we build a high-quality migratory bird microbial genome and gene (MBGG) catalog that includes 5,823 metagenome-assembled genomes (MAGs), 13,072 plasmid sequences, 15678 putative secondary metabolite biosynthetic gene clusters, and 44,974 viral genomes, and these MAGs represent 1,709 candidate species spanning 36 phyla.
...
How to Reference? If you have used this script in your research, please use the following link for references to our script: https://github.com/NANYW123/migratory-bird-microbiome-catalog-MBGG.git. Please also cite the corresponding software and <A genomic catalog of migratory microbiomes from wild birds across China’s habitats>.

Software and database installation. Most of the software can be installed through conda. The installation method refers to the manual of each software. The following published software is used in the pipeline. The name, version, and availability of the software are as follows:
...
vConTACT2 v0.11.3 (https://bitbucket.org/MAVERICLab/vcontact2/src/master/)

GeNomad v1.7.1 (https://github.com/apcamargo/genomad/)
...
metaVF 2.0 (https://github.com/Wanting-Dong/MetaVF_toolkit)
...
BiG-SCAPE v2.0.0 (https://github.com/medema-group/BiG-SCAPE)

DRAM v1.5.0 (https://github.com/shafferm/DRAM)
...
Cytoscape v3.10.4 (https://cytoscape.org/)

Note: The version are only the version used in the paper, most of database are constantly updated. OVERVIEW OF PIPELINE The scripts of whole-genome sequencing analysis are placed in "Pipeline" directory.
...
Limitations: This workflow was designed specifically for "A genomic catalog of migratory microbiomes from wild birds across China’s habitats"; editing and revisions might be required before applying to other projects.
